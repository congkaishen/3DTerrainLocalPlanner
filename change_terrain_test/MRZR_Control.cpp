...
double initial_state[4] = { 0.0, 0.0,  0.2 , CH_C_PI_4};
double goal[2] = { 100.0, 100.0 };
double friction = 0.6;
...
void run_sim() {
    ...
    vehicle.Initialize(ChCoordsys<>(ChVector<>(initial_state[0], initial_state[1], initial_state[2]), Q_from_AngZ(initial_state[3])));
    ...
    cylinder->GetCylinderGeometry().p2 = ChVector<>(0.0,0.0, -0.2);
    ...
    cylinder2->GetCylinderGeometry().p2 = ChVector<>(0.0, 0.0, -0.2);
    cylinder2->GetCylinderGeometry().rad = 3.0;
    cylinder2->AddMaterial(green_mat);
    body2->AddVisualShape(cylinder2, ChFrame<>(ChVector<>(goal[0], goal[1], -9*sin(goal[0]/15)* sin(goal[1] / 15)), QUNIT));
    ...
    cylinder5->GetCylinderGeometry().p1 = ChVector<>(0.0, 0.0, -9.0);
    cylinder5->GetCylinderGeometry().p2 = ChVector<>(0.0, 0.0, 12.0);
    cylinder5->GetCylinderGeometry().rad = 10.0;
    cylinder5->AddMaterial(black_mat);


    body3->AddVisualShape(cylinder4, ChFrame<>(ChVector<>(15.0, 15.0, -9.0 * sin(15.0 / 15.0) * sin(15.0 / 15.0)), QUNIT));
    body3->AddVisualShape(cylinder5, ChFrame<>(ChVector<>(10.0, 70.0, -9.0 * sin(10.0 / 15.0) * sin(70.0 / 15.0)), QUNIT));
    body3->AddVisualShape(cylinder5, ChFrame<>(ChVector<>(70.0, 10.0, -9.0 * sin(70.0 / 15.0) * sin(10.0 / 15.0)), QUNIT));
